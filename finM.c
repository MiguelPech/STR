...
//Global variables
char position[64]; 	//tendras valores obtenidos del serial
int dirA,dirB; 		// para estar cambiando en los motores para hacer el pwm
float potA,potB; 	//
...
void startup(){
	...
	//asignan como salida a los pines para los motores
	...
	*            priority,   LA priorida más alta es 99 y la más baja es 1.
	*            mode (FPU, start suspended, ...)
	*/
	//rt_task_create(&demo_task, str, 0, 50, 0);
	rt_task_create(&serial_communication_task, "comunicacion", 0, 50, 0);
